            ...
            <div className=" py-24">
                <div className="mx-auto w-full max-w-5xl px-6">
                    <div className="text-center">
                        <h2 className="text-foreground text-4xl font-semibold">Inventario y Ventas sin complicaciones</h2>
                        <p className="text-muted-foreground mb-12 mt-4 text-balance text-lg">Controla stock, precios y ventas en un solo lugar. Reportes claros para tomar decisiones rápidas.</p>
                    ...
                    <div className="border-foreground/10 relative mt-16 grid gap-12 border-b pb-12 [--radius:1rem] md:grid-cols-2">
                        <div>
                            <h3 className="text-foreground text-xl font-semibold">Gestión de Inventario</h3>
                        ...
                        <div>
                            <h3 className="text-foreground text-xl font-semibold">Ventas y Cajas</h3>
                            <p className="text-muted-foreground my-4 text-lg">Registra ventas en segundos y controla cierres de caja diarios.</p>
                            <Card
                    ...
                    <blockquote className="before:bg-primary relative mt-12 max-w-xl pl-6 before:absolute before:inset-y-0 before:left-0 before:w-1 before:rounded-full">
                        <p className="text-foreground text-lg">“La gestión del minimarket ahora es más simple. Vemos el stock y las ventas al instante.”</p>
                        <footer className="mt-4 flex items-center gap-2">
                            <cite>Cliente ARAMAC</cite>
                            <span
                                aria-hidden
